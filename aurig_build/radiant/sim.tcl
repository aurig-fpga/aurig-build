...
# -----------------------------------------------------------------------------
# aurig_build/radiant/sim.tcl
#
# Radiant has no native Tcl-driven simulator. This wrapper exists for
# users who source the per-vendor sim TCL directly from a Makefile / IDE
# (e.g. `radiantc aurig_build/radiant/sim.tcl <config.yaml> [<tb>]`); it locates
...
# dispatcher defaults `tool.sim.kind` to `questa` when synth is Radiant.
# -----------------------------------------------------------------------------
